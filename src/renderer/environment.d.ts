  ...
  interface Window {
    mindmap: {
      ...
      assistant: {
        ...
        chat(messages: Array<{ role: "user" | "assistant"; content: string }>, mode: "draft" | "edit" | "full", interactionMode: "chat" | "note", conversationStyle: "default" | "professional"): Promise<{ text: string; changed: boolean; approval?: { id: string; requiredMode: "edit" | "full"; reason: string } }>;
